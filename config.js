...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : '263714406565';
...
global.sudo =  process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : '263714406565'; ;
